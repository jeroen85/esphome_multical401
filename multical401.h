...
class Multical401 : public PollingComponent, public UARTDevice {
 public:
  ...
  // Sensor *sensor_energy = new Sensor();
  // Sensor *sensor_volume = new Sensor();
  // Sensor *sensor_tempin = new Sensor();
  // Sensor *sensor_tempout = new Sensor();
  // Sensor *sensor_tempdiff = new Sensor();
  // Sensor *sensor_power = new Sensor();
  // Sensor *sensor_flow = new Sensor();


  // Multical401(uint32_t update_interval, UARTComponent *uart_tx, UARTComponent *uart_rx) : PollingComponent(update_interval) {
